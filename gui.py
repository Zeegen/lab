...
class GUI(play.Play):
    ...
    Правила пасьянсу. Уважається, що даний пасьянс розкладала як гадання Жозефіна Богарне й результат даного пасьянсу була відповідь на поставлене питання. Правила пасьянсу наступні. Перед розкладанням пасьянсу ставиться питання, потім дві колоди змішуються в одну, після чого отримана колода ретельно тасується й викладаються 10 вертикальних рядів карт по 4 карти в кожному ряді. Колода, що залишилась, кладеться поруч. Зверху розташовуються 8 місць для базових стопок. Стартовими картами в базових стопках є тузи, які кладуть туди в процесі гри. Дозволяється переміщати нижні повністю відкриті карти вертикальних рядів і верхню карту колоди, що залишилася, в ігрових рядах у спадній послідовності в масть. Якщо ряд залишається без карт, то дозволяється на порожнє місце покласти будь-яку карту.
    
    Пасьянс зійшовся, якщо всі карти зібрані на базових стопках у висхідних послідовностях у масть, у цьому випадку відповіддю на поставлене питання є "так", в іншому випадку "ні".

    Локалізація позиції налаштована так, що за перенесення карти стопка призначення визначається за позицією курсора, а не за перетином карти з її майбутнім місцем розташування.
"""
